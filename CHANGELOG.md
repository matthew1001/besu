...
### Bug fixes
- Fixed a deadlock that could permanently wedge a BFT validator, leaving it stuck behind its peers with consensus and chain download both halted. `SyncState` no longer holds its own monitor while notifying sync-status subscribers.
