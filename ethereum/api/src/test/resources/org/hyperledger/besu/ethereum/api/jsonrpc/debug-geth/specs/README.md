...
tracer configurations. Specs are captured from the pinned Docker image `ethereum/client-go:v1.17.5`; bumping the
...
5. Regenerate specs for every tracer sharing this chain (`prestateTracer`, `callTracer`,
   ...
   (e.g. the `diff-mode-true` `codeHash: 0x0…0` post entries introduced by go-ethereum #34675,
